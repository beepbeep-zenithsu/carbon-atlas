...
export declare class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
    ...
    render(): FunctionComponentElement<PropsWithChildren<ErrorBoundaryContextType>>;
}
...
export declare function withErrorBoundary<Type extends ComponentType<any>>(Component: Type, errorBoundaryProps: ErrorBoundaryProps): ForwardRefExoticComponent<PropsWithoutRef<JSX.LibraryManagedAttributes<Type, ComponentProps<Type>>> & RefAttributes<ComponentRef<Type>>>;
